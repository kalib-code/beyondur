            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-lg transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="my-2 h-auto w-auto border">
                    {videoFormStep === 0 ? (
                      <Webcam
                        mirrored={true}
                        audio={false}
                  ...
                  {videoFormStep === 0 ? (
                    <>
                      ...
                      <div className="mt-4">
                        <button
                          type="button"
                          className="btn-primary btn my-2 w-full"
                        ...
                        <button
                          type="button"
                          className="btn-ghost btn my-2 w-full"
                          onClick={closeModal}
                        >
                          Upload from file
                        </button>
                  ...
                  {videoFormStep === 2 ? (
                    <>
                      <div className=" h-fit w-fit justify-center">
                        {
                          // @ts-ignore
                          <Plyr {...sourceData} />
                        }
                      ...
                      <div className="my-5 flex w-full flex-col">
                        <form onSubmit={form.onSubmit(values => onSubmitVideo(values))}>
                          ...
                          <input
                            type="text"
                            className="input-bordered input my-2 w-full max-w-lg"
